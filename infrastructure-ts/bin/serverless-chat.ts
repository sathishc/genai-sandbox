...
const agentApiStack = new AgentApiStack(app, 'AgentApiStack', {
  logLevel: LOG_LEVEL,
  messagesTable: databaseStack.messagesTable,
  agentsTable: databaseStack.agentsTable,
  connectionsTable: databaseStack.connectionsTable,
...
agentApiStack.addDependency(authStack);
agentApiStack.addDependency(websocketApiStack);
agentApiStack.addDependency(databaseStack);
